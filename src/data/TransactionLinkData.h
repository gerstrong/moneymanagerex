...
// PLEASE EDIT!
//
// This is only sample code re-used from "table/TransactionLinkTable.h".
//
...
struct TransactionLinkData
{
    ...
    explicit TransactionLinkData();
    explicit TransactionLinkData(wxSQLite3ResultSet& q);
    TransactionLinkData(const TransactionLinkData& other) = default;

    int64 id() const { return TRANSLINKID; }
    void id(const int64 id) { TRANSLINKID = id; }
    TransactionLinkRow to_row() const;
    TransactionLinkData& from_row(const TransactionLinkRow& row);
    void to_insert_stmt(wxSQLite3Statement& stmt, int64 id) const;
    void to_update_stmt(wxSQLite3Statement& stmt) const;
    TransactionLinkData& from_select_result(wxSQLite3ResultSet& q);
    ...
    {
        bool operator()(const TransactionLinkData& x, const TransactionLinkData& y)
        {
...
inline TransactionLinkData::TransactionLinkData(wxSQLite3ResultSet& q)
{
    from_select_result(q);
}

inline void TransactionLinkData::to_insert_stmt(wxSQLite3Statement& stmt, int64 id) const
{
    to_row().to_insert_stmt(stmt, id);
}

inline void TransactionLinkData::to_update_stmt(wxSQLite3Statement& stmt) const
{
    to_row().to_update_stmt(stmt);
}

inline TransactionLinkData& TransactionLinkData::from_select_result(wxSQLite3ResultSet& q)
{
    return from_row(TransactionLinkRow().from_select_result(q));
}
...
inline row_t TransactionLinkData::to_html_row() const
{
    return to_row().to_html_row();
}

inline void TransactionLinkData::to_html_template(html_template& t) const
{
    to_row().to_html_template(t);
}

inline TransactionLinkData& TransactionLinkData::clone_from(const TransactionLinkData& other)
{
    *this = other;
    id(-1);
    return *this;
