...
struct TransactionLinkRow
{
    ...
    TransactionLinkRow& from_select_result(wxSQLite3ResultSet& q);
    ...
    TransactionLinkRow& clone_from(const TransactionLinkRow& other);
    bool equals(const TransactionLinkRow* other) const;
...
inline TransactionLinkRow::TransactionLinkRow(wxSQLite3ResultSet& q)
{
    from_select_result(q);
}

inline void TransactionLinkRow::to_update_stmt(wxSQLite3Statement& stmt) const
{
    to_insert_stmt(stmt, id());
}

inline TransactionLinkRow& TransactionLinkRow::clone_from(const TransactionLinkRow& other)
{
    *this = other;
    id(-1);
    return *this;
