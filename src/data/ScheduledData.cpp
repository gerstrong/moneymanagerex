...
// PLEASE EDIT!
// This is only sample code re-used from "table/ScheduledTable.cpp".

#include "ScheduledData.h"
...
// Convert ScheduledData to ScheduledRow
ScheduledRow ScheduledData::to_row() const
{
    ScheduledRow row;
...
// Convert ScheduledRow to ScheduledData
ScheduledData& ScheduledData::from_row(const ScheduledRow& row)
{
    BDID = row.BDID; // int64
