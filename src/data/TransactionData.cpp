...
// PLEASE EDIT!
// This is only sample code re-used from "table/TransactionTable.cpp".
...
// Convert TransactionData to TransactionRow
TransactionRow TransactionData::to_row() const
{
    TransactionRow row;
...
// Convert TransactionRow to TransactionData
TransactionData& TransactionData::from_row(const TransactionRow& row)
{
