...
double CategoryReport::AppendData([[maybe_unused]] const std::vector<CategoryReport::data_holder> &data, std::map<int64, std::map<int, double>> &categoryStats, const CategoryData* category, int64 groupID, int level) {
